...
#define AI_NETWORK_MODEL_SIGNATURE     "1ad7df6582faefff96ad00bcca237d6b"
...
#define AI_TOOLS_DATE_TIME   "Mon Jul 10 22:10:32 2023"
...
AI_ARRAY_OBJ_DECLARE(
  dense_19_dense_bias_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  dense_18_dense_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 7, AI_STATIC)
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#5 */
AI_ARRAY_OBJ_DECLARE(
  dense_19_dense_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 7, AI_STATIC)
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#9 */
AI_ARRAY_OBJ_DECLARE(
  dense_20_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 4, AI_STATIC)
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  dense_18_dense_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 84, AI_STATIC)
/* Array#11 */
AI_ARRAY_OBJ_DECLARE(
  dense_18_dense_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 7, AI_STATIC)
/* Array#12 */
AI_ARRAY_OBJ_DECLARE(
  dense_19_dense_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 49, AI_STATIC)
/**  Tensor declarations section  *********************************************/
/* Tensor #0 */
AI_TENSOR_OBJ_DECLARE(
  dense_19_dense_bias, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 7, 1, 1), AI_STRIDE_INIT(4, 4, 4, 28, 28),
  1, &dense_19_dense_bias_array, NULL)
...
/* Tensor #2 */
AI_TENSOR_OBJ_DECLARE(
  dense_18_dense_output, AI_STATIC,
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 7, 1, 1), AI_STRIDE_INIT(4, 4, 4, 28, 28),
  1, &dense_18_dense_output_array, NULL)

/* Tensor #3 */
AI_TENSOR_OBJ_DECLARE(
  dense_20_dense_weights, AI_STATIC,
  3, 0x0,
  AI_SHAPE_INIT(4, 7, 4, 1, 1), AI_STRIDE_INIT(4, 4, 28, 112, 112),
...
/* Tensor #5 */
AI_TENSOR_OBJ_DECLARE(
  dense_19_dense_output, AI_STATIC,
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 7, 1, 1), AI_STRIDE_INIT(4, 4, 4, 28, 28),
  1, &dense_19_dense_output_array, NULL)
...
/* Tensor #10 */
AI_TENSOR_OBJ_DECLARE(
  dense_18_dense_weights, AI_STATIC,
  10, 0x0,
  AI_SHAPE_INIT(4, 12, 7, 1, 1), AI_STRIDE_INIT(4, 4, 48, 336, 336),
  1, &dense_18_dense_weights_array, NULL)

/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  dense_18_dense_bias, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 7, 1, 1), AI_STRIDE_INIT(4, 4, 4, 28, 28),
  1, &dense_18_dense_bias_array, NULL)

/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  dense_19_dense_weights, AI_STATIC,
  12, 0x0,
  AI_SHAPE_INIT(4, 7, 7, 1, 1), AI_STRIDE_INIT(4, 4, 28, 196, 196),
  1, &dense_19_dense_weights_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_19_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_19_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_19_dense_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_18_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_19_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &dense_19_dense_weights, &dense_19_dense_bias),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  dense_19_dense_layer, 1,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &dense_19_dense_chain,
  NULL, &dense_19_layer, AI_STATIC, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_18_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_18_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_18_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  nl, forward_relu,
  &dense_18_chain,
  NULL, &dense_19_dense_layer, AI_STATIC, 
  .nl_params = NULL, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_18_dense_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_18_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &dense_18_dense_weights, &dense_18_dense_bias),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  dense_18_dense_layer, 0,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &dense_18_dense_chain,
  NULL, &dense_18_layer, AI_STATIC, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_20_output),
  &dense_18_dense_layer, 0, NULL)
